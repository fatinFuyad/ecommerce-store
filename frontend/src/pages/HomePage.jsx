...
const HomePage = () => {
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 py-8">
        {featuredProducts.length > 0 && (
          <FeaturedProducts featuredProducts={featuredProducts} />
        )}

        <h1 className="text-center text-5xl sm:text-6xl font-bold text-emerald-400 mt-20 mb-6">
